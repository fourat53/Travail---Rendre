...
public class Prosit6 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Le salaire de c2 est: "+c2.SalaireEmployee()+"DT");
        ...
        */
        ...
        try {
            p1 = new produitFruit(1254, "Fraise", "", 12.3f, "Mars", 10);
        } 
        catch (PrixNegatifException exp) {}
        
        produitFruit p2 = null;
        try {
            p2 = new produitFruit( 1224, "Pastèque", "", 50f, "Juin",0);
        }
        catch (PrixNegatifException exp) {
            System.out.println("");
        }
        ...
        try {
            p3 = new produitFruit( 7896, "Mandarine", "",25.6f, "Décembre", 0);
        }
        catch (PrixNegatifException exp) {}

        produitLegume p4 = null;
        try {
            p4 = new produitLegume( 8521, "Artichauts", "",14f, "Janvier", 0);
        } 
        catch (PrixNegatifException exp) {}
        ...
        catch (MagasinPleinException exp) {
            System.out.println("Une exception  a été levé");
            System.err.println(exp.getMessage());
        }

        System.out.println("Produit Frais: " + p4.estFrais("Février"));

        System.out.println("Quantité totale du fruit: " + Carrefour.calculStock());
